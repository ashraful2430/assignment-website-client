      ...
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          <h3 className="font-bold text-lg">
            Please submit the require information
          </h3>
          <form onSubmit={handleSubmitAssignment}>
            ...
            <div>
              ...
              <textarea
                placeholder="Note"
                name="note"
                className="block  mt-2 w-full placeholder-gray-400/70 0 rounded-lg border border-gray-200 bg-white px-4 h-32 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40   "
              ></textarea>
            </div>
          ...
          <div>
            <button
              className="btn bg-red-500 w-full mt-2 text-white"
              onClick={() => document.getElementById("my_modal_5").close()}
            >
              Close
            </button>
