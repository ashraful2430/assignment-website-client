                ...
                <section className="relative flex flex-col-reverse lg:flex-col flex-wrap lg:h-screen lg:items-center">
                    <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                        ...
                        <form onSubmit={handleLogIn} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                            ...
                            <div className="">
                                <Link to={'/register'}>
                                    <p className="text-gray-400">Do not have any account? <span className="font-bold text-blue-500 hover:cursor-pointer">Register here</span></p>
                                </Link>
                                <button
                                ...
                                <div className="">
                                    <div className="flex flex-col w-full gap-y-5 ">
                                        <button onClick={handleGoogleSignIn} className="bg-white flex items-center text-gray-700 justify-center gap-x-3 text-sm sm:text-base w-full    rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5">
