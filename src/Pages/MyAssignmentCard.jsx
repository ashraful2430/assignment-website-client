...
const MyAssignmentCard = ({ assignments }) => {
    ...
    const { email, title, userName, marks, thumbnail, date, } = assignments;
    return (
            ...
            <div className="p-6">
                <div>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <p className='font-semibold block mt-2 text-gray-800 transition-colors duration-300 transform  hover:text-gray-600 hover:underline'>Difficulty: {marks}</p>
                    </div>
                ...
                <div className="mt-4">
                    <div className="flex items-center">
                        ...
                        <span className="mx-1 text-xs text-gray-600">{date.slice(0, 10)}</span>
                    </div>
                </div>
            </div>
        </div>
