        ...
        <div className="w-full navbar bg-base-100 shadow-xl">
            <Container>
                ...
                {user?.email ? (
                    ...
                    <Link to="/login">
                        <button className="inline-block rounded border border-current px-8 py-3 text-sm font-medium text-white bg-red-500 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-pink-500">Login</button>
                    </Link>
                )}
                <div>
